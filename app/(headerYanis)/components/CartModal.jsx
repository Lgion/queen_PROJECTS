...
export default function CartModal({ isOpen, setIsOpen, cartItems, setCartItems }) {
    ...
    return (
        <Transition show={isOpen} as={Fragment}>
            <Dialog as="div" className="fixed inset-0 z-50" onClose={() => setIsOpen(false)}>
                        ...
                        <div className="h-full flex flex-col">
                            ...
                            <div className="px-4 py-6 bg-gray-50">
                                <div className="flex items-center justify-between">
                                    <Dialog.Title className="text-lg font-medium">Votre panier ({cartItems.length})</Dialog.Title>
                                    <button className="p-2 rounded-full hover:bg-gray-200" onClick={() => setIsOpen(false)}>
                                    ...
                                    {cartItems.length === 0 ? (
                                        ...
                                        cartItems.map((item) => (
                                            ...
                                            >
                                                ...
                                                <button onClick={() => updateQuantity(item.id, -item.quantity)} className="p-2 text-gray-400 hover:text-red-500">
