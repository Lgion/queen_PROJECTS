            ...
            <div className="relative h-[70vh] rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <Link href="/products" className="bg-orange-600 text-white px-8 py-3 rounded-full hover:bg-orange-700 transition duration-300 inline-flex items-center">
                    Voir les produits
              ...
              {featuredProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/product/${product.id}`} className="block w-full text-center bg-orange-600 text-white py-2 rounded hover:bg-orange-700 transition duration-300">
                      Voir détails
                    </Link>
                  </div>
                </div>
              ...
              {[1, 2, 3].map((post) => (
                <div key={post} className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <Link href={`/blog/${post}`} className="text-orange-600 hover:underline inline-flex items-center">
                      Lire la suite
